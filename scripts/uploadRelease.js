  ...
  try {
      ...
      for (const element in rawChangeLog) {
        if (rawChangeLog[element].length) {
          ...
          for (const e of rawChangeLog[element]) {
            ...
            const advanced =
              e?.advanced?.cm &&
              ` ([${e?.advanced?.cm}](https://github.com/Kome-Lab/Kome-LabGDLauncher/commit/${e?.advanced?.cm})` +
                `${
                  prSplit
                    ? ` | [#${e?.advanced.pr}](https://github.com/Kome-Lab/Kome-LabGDLauncher/pull/${prSplit[0]}` +
    ...
    const { data: newRelease } = await axios.default.post(
      'https://api.github.com/repos/Kome-Lab/Kome-LabGDLauncher/releases',
      {
        ...
        body: `# Kome-LabGDLauncher  ## このLauncherは [gorilla-devs/GDLauncher](https://github.com/gorilla-devs/GDLauncher) を元にして作られたランチャーギリ  ## このバージョンはBeta版なので使わない方が良いギリ  <br>  # ChangeLog  ${getChangeLog()}  <br>  # ダウンロードはこちら！  ### [Windows](https://github.com/Kome-Lab/Kome-LabGDLauncher/releases/download/v${version}/Kome-LabGDLauncher-win-setup.exe)  ### [Mac](https://github.com/Kome-Lab/Kome-LabGDLauncher/releases/download/v${version}/Kome-LabGDLauncher-mac-setup.dmg)  ### [Linux-AppImage](https://github.com/Kome-Lab/Kome-LabGDLauncher/releases/download/v${version}/Kome-LabGDLauncher-linux-setup.AppImage)  ### [Linux-deb](https://github.com/Kome-Lab/Kome-LabGDLauncher/releases/download/v${version}/Kome-LabGDLauncher-linux-setup.deb)  ### [Linux-rpm](https://github.com/Kome-Lab/Kome-LabGDLauncher/releases/download/v${version}/Kome-LabGDLauncher-linux-setup.rpm)`
      },
      {
        headers: {
          Authorization: `token ${process.env.GH_ACCESS_TOKEN_RELEASES}`
